...
class SOLUTION:
    ...
    def Create_Body(self):
        ...
        # pyrosim.Send_Joint(name="Torso_RightLeg", parent="Torso", child="RightLeg", type="revolute", position=[0.5, 0, 1], jointAxis="0 0 1")
        ...
        # pyrosim.Send_Joint(name="BackLeg_LowerBackLeg", parent="BackLeg", child="LowerBackLeg", type="revolute", position=[0, -1, 0], jointAxis="0 0 1")
        ...
        # pyrosim.Send_Joint(name="RightLeg_LowerRightLeg", parent="RightLeg", child="LowerRightLeg", type="revolute", position=[1, 0, 0], jointAxis="0 0 1")
        ...
        # pyrosim.Send_Cube(name="BackLeg2", pos=[0.5, -0.5, 0], size=[0.2, 0.2, 1])
        # #lower part
        # pyrosim.Send_Joint(name="BackLeg2_LowerBackLeg2", parent="BackLeg2", child="LowerBackLeg2", type="revolute", position=[0, -1, 0], jointAxis="0 0 1")
        # pyrosim.Send_Cube(name="LowerBackLeg2", pos=[0.5, 0, -0.5], size=[0.2, 0.2, 1])
        ...
        # #Lower prt
        # pyrosim.Send_Joint(name="FrontLeg_LowerFrontLeg2", parent="FrontLeg2", child="LowerFrontLeg2", type="revolute", position=[0, 1, 0], jointAxis="1 0 0")
        # pyrosim.Send_Cube(name="LowerFrontLeg2", pos=[0.5, 0, -0.5], size=[0.2, 0.2, 1])
...
# motor neurons 
        ...
        # # 5th and 6th legs
        # pyrosim.Send_Motor_Neuron(name=11, jointName="Torso_BackLeg2")
        # pyrosim.Send_Motor_Neuron(name=12, jointName="Torso_FrontLeg2")
        # pyrosim.Send_Motor_Neuron(name=13, jointName="BackLeg_LowerBackLeg2")
        # pyrosim.Send_Motor_Neuron(name=14, jointName="FrontLeg_LowerFrontLeg2")
        # pyrosim.Start_NeuralNetwork("brain" + str(self.myID) + ".nndf")
